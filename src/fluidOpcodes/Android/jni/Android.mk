...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../../H $(LOCAL_PATH)/../../../../include $(LOCAL_PATH)/../../../.. $(LOCAL_PATH)/../../../ $(LIBSNDFILE_SRC_DIR) $(LIBFLUIDSYNTH_SRC_DIR)/include $(LOCAL_PATH)/../.. $(LOCAL_PATH)/../../../CsoundAndroid/jni 
...
LOCAL_SRC_FILES := ../../fluidOpcodes.cpp 
